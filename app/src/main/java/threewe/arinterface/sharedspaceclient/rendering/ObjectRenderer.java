 ...
 */
package threewe.arinterface.sharedspaceclient.rendering;
...
//        InputStream objInputStream = context.getAssets().open(objAssetName);
        InputStream objInputStream = context.openFileInput(objAssetName);
     ...
     * @param objAssetName  Name of the OBJ file containing the model geometry.
     */
    public void createOnGlThread(Context context, String objAssetName) throws IOException {
//        // Read the texture.
//        Bitmap textureBitmap = BitmapFactory.decodeStream(
//                context.getAssets().open(diffuseTextureAssetName));
...
//        mMaterialParametersUniform = GLES20.glGetUniformLocation(mProgram, "u_MaterialParameters");
     ...
     * @see Matrix
     */
    public void draw(float[] cameraView, float[] cameraPerspective, float lightIntensity, boolean material) {
